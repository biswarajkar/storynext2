...
# np.save('processing/vectorizedTrainingMatrix', ids)

print(time.strftime("%H:%M:%S", time.gmtime(time.time() - start_time)), "-- Vectorized Training Reviews Saved --", " (", datetime.now().strftime('%Y-%m-%d %H:%M:%S'), ")")
